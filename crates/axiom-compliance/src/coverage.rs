...
///
/// Returns flags needed for GCC coverage: --coverage, -fprofile-arcs, -ftest-coverage
...
pub fn parse_gcov_output(gcov_output: &str) -> Result<(Vec<LineData>, Vec<BranchData>), CoverageError> {
...
///
/// Takes a map of file paths to their gcov output and generates a complete coverage report
...
"#;
    ...
    fn test_calculate_statement_coverage_returns_50_percent_for_5_of_10() {
        let lines = vec![
            ...
            LineData { line_number: 2, execution_count: Some(3) },
            LineData { line_number: 3, execution_count: Some(1) },
            LineData { line_number: 4, execution_count: Some(2) },
            LineData { line_number: 5, execution_count: Some(1) },
            LineData { line_number: 6, execution_count: Some(0) },
            LineData { line_number: 7, execution_count: Some(0) },
            LineData { line_number: 8, execution_count: Some(0) },
            LineData { line_number: 9, execution_count: Some(0) },
            LineData { line_number: 10, execution_count: Some(0) },
        ];
    ...
    fn test_calculate_branch_coverage_returns_75_percent_for_3_of_4() {
        let branches = vec![
            ...
            BranchData { line_number: 2, taken: true },
            BranchData { line_number: 3, taken: true },
            BranchData { line_number: 4, taken: false },
        ];
