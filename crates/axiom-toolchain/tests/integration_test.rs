...
fn test_error_display_not_found() {
    ...
    assert!(display.contains("ARM toolchain not found"), 
...
fn test_error_display_incomplete() {
    let missing = vec!["arm-none-eabi-gdb".to_string(), "arm-none-eabi-size".to_string()];
    let error = ArmToolchainError::incomplete(missing);
    let display = format!("{}", error);
    
    assert!(display.contains("incomplete"), "Error message should mention incomplete");
    assert!(display.contains("arm-none-eabi-gdb"), "Error message should list missing tools");
    assert!(display.contains("arm-none-eabi-size"), "Error message should list missing tools");
}
...
fn test_error_display_version_too_old() {
    ...
    assert!(display.contains("7.3.1"), "Error message should show found version");
    assert!(display.contains("8.0.0"), "Error message should show required version");
    assert!(display.contains("too old"), "Error message should mention version is too old");
}
...
fn test_error_display_linker_script_not_found() {
    ...
    assert!(display.contains("Linker script not found"), "Error message should mention linker script");
    assert!(display.contains("script.ld"), "Error message should include file name");
}
...
fn test_error_display_memory_overflow() {
    ...
    assert!(display.contains("Memory overflow"), "Error message should mention memory overflow");
    assert!(display.contains("FLASH"), "Error message should mention region");
    assert!(display.contains("2048 bytes"), "Error message should include details");
}
...
fn test_error_display_compilation_failed() {
    ...
    assert!(display.contains("Compilation failed"), "Error message should mention compilation failed");
    assert!(display.contains("2 error"), "Error message should show error count");
}
...
fn test_macos_installation_suggestion() {
    ...
    assert!(display.contains("Homebrew") || display.contains("brew"), 
            "macOS error should mention Homebrew");
    assert!(display.contains("gcc-arm-embedded") || display.contains("arm.com"),
...
fn test_linux_installation_suggestion() {
    ...
    assert!(display.contains("apt-get") || display.contains("dnf"), 
            "Linux error should mention package manager");
    assert!(display.contains("gcc-arm-none-eabi") || display.contains("arm-none-eabi-gcc"),
...
fn test_windows_installation_suggestion() {
    ...
    assert!(display.contains("ARM Developer") || display.contains("developer.arm.com"), 
            "Windows error should mention ARM Developer");
    assert!(display.contains("Chocolatey") || display.contains("choco"),
...
fn test_empty_source_file() {
    ...
    assert_eq!(result.exit_code, 0, "Empty file should compile: {}", result.stderr);
...
fn test_unicode_in_comments() {
    ...
    assert_eq!(result.exit_code, 0, "Unicode in comments should compile: {}", result.stderr);
...
fn test_very_long_lines() {
    ...
    assert_eq!(result.exit_code, 0, "Very long lines should compile: {}", result.stderr);
...
fn test_deeply_nested_includes() {
    ...
    assert_eq!(result.exit_code, 0, "Deeply nested includes should compile: {}", result.stderr);
...
fn test_inline_assembly() {
    ...
    assert_eq!(result.exit_code, 0, "Inline assembly should compile: {}", result.stderr);
...
fn test_preprocessor_heavy_macros() {
    ...
    assert_eq!(result.exit_code, 0, "Heavy macros should compile: {}", result.stderr);
...
fn test_invalid_mcu_config() {
    ...
    assert!(result.stderr.contains("unknown") || 
            ...
            "Error should mention invalid/unknown CPU: {}", result.stderr);
...
fn test_circular_includes() {
    ...
    assert_eq!(result.exit_code, 0, "Circular includes with guards should compile: {}", result.stderr);
